...
This page is written using **Markdown**. GitHub Pages will take this Markdown file and *render it as an HTML webpage*.
...
<a href="index.html">← Return to The Gaming Hub</a>
